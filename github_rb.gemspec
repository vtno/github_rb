...
require "github_rb/version"

Gem::Specification.new do |spec|
  spec.name          = "github_rb"
  spec.license       = "MIT"
  spec.version       = GithubRb::VERSION
  spec.authors       = ["Tino Thamjarat"]
  spec.email         = ["tino.thamjarat@gmail.com"]
  ...
  spec.extensions    = ["ext/github_rb/extconf.rb"]
